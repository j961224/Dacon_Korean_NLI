...
class LSTM_Model(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # LSTM last hidden, cell state shape : (2, 244, 1024) (num_layer, seq_len, hidden_size) -> 2개 layer
        hidden, (last_hidden, last_cell)= self.lstm(output)

        # (16, 1024) (batch, hidden_dim) -> back and forward last hidden states concat
